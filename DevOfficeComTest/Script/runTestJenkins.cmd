...
"%MSBuildV14%" .\DevOfficeComTest.sln /t:Rebuild /clp:ErrorsOnly /v:m
...
if defined testFilter (
 "%VSTest%" .\Tests\bin\Debug\Tests.dll /logger:trx !testFilter!
) else if defined testCases (
 "%VSTest%" .\Tests\bin\Debug\Tests.dll /logger:trx !testCases!
 ...
 "%VSTest%" .\Tests\bin\Debug\Tests.dll /logger:trx !tests:~0,-1!
) else (
 "%VSTest%" .\Tests\bin\Debug\Tests.dll /logger:trx
)
endlocal
